    ...
    <section id="blog" className="relative py-16 sm:py-24">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-12">
          <div>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] font-medium bg-black/[0.04] dark:bg-white/[0.04] text-ink-muted border border-black/[0.06] dark:border-white/[0.06] mb-6">
          ...
          <Link
            href="/blog"
            className="hidden sm:flex items-center gap-2 text-sm font-medium text-ink-muted hover:text-black dark:hover:text-white transition-colors"
          >
                ...
                <Link href={`/blog/${post.slug}`} className="block group h-full">
                  <div className="glass-card rounded-xl p-5 border border-black/[0.06] dark:border-white/[0.06] hover:border-black/[0.12] dark:hover:border-white/[0.12] transition-all duration-300 h-full">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="px-2 py-1 rounded-full text-[9px] font-semibold bg-black/[0.04] dark:bg-white/[0.04] text-ink-muted border border-black/[0.06] dark:border-white/[0.06]">
                        {post.category}
                      </span>
                      <span className="flex items-center gap-1 text-[10px] text-ink-muted dark:text-ink-faint">
        ...
        <div className="mt-8 sm:hidden text-center">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-sm font-medium text-ink-muted hover:text-black dark:hover:text-white transition-colors"
          >
            View all {allPosts.length} posts
            <ArrowRight className="w-4 h-4" />
          </Link>
