    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-black/80 border-b border-white/[0.04]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <span className="text-[11px] uppercase tracking-wider text-ink-faint">Press</span>
        </div>
      </header>

      <main id="main" className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
        {/* Page Header */}
        <div className="mb-16">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4">
              {[
                ...
                <div key={stat.label} className="text-center p-3 rounded-xl bg-white/[0.02] border border-white/[0.04]">
                  ...
                  <p className="text-[10px] text-ink-muted uppercase tracking-wider">{stat.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="glass-card p-8 flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-ink-muted">Logo on dark background</p>
            </div>
            ...
            <div className="glass-card p-8 flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-ink-muted">App Icon</p>
            </div>
          </div>
        </section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
            {[
              ...
              <div key={color.name} className="text-center">
                ...
                <p className="text-sm text-ink-muted">{color.name}</p>
              </div>
            ))}
          </div>
        </section>
          ...
          <div className="glass-card p-6 sm:p-8">
            <div className="space-y-3">
              {[
                ...
                { q: "How much does it cost?", a: "Free to download and use, with no ads. Premium features are planned for later." },
                ...
                { q: "Where is it available?", a: "Android on Google Play. iOS is in open TestFlight beta — not yet on the public App Store." },
              ].map((item) => (
                <div key={item.q} className="flex gap-4 py-2 border-b border-white/[0.03] last:border-0">
                  ...
                  <span className="text-sm text-ink-muted">{item.a}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <section>
          ...
          <div className="glass-card p-6 sm:p-8 text-center">
            <Mail className="w-8 h-8 text-ink-faint mx-auto mb-4" />
